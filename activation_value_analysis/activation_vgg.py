...
from dnnbrain.dnn.models import VggFace
...
dnn.model.load_state_dict(torch.load('/nfs/a1/userhome/xiehailun/workingdir/new_study/dnn/transfer_DCNN/vgg_face.pth'))
...
# Save out (fc3 activation saved fc8 by name)
out_file = pjoin(TMP_DIR, '/nfs/a1/userhome/xiehailun/workingdir/new_study/result/vggface_test_fc8.act.h5')
